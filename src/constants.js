...
export const COBAIA_PARTS = [
    { name: 'body',  pos: [0, 0.3, 0] /*[-0.094, 0.619, 0.866]*/, scale: [0.2, 0.2, 0.15], rot: [0, 0, 0] },
    { name: 'head',  pos: [0, 0.49, 0]/*[-0.094, 0.821, 0.866]*/, scale: [0.2, 0.2, 0.18], rot: [0, -24.2, 0] },
    { name: 'arm1',  pos: [-0.13, 0.3, 0]/*[-0.222, 0.616, 0.866]*/, scale: [0.05, 0.15, 0.05], rot: [0, 0, -10] },
    { name: 'arm2',  pos: [0.13, 0.3, 0] /*[0.038, 0.616, 0.866]*/,  scale: [0.05, 0.15, 0.05], rot: [0, 0, 10] },
    ...
    { name: 'eye1',  pos: [-0.05, 0.5, 0.1]/*[-0.093, 0.823, 0.963]*/, scale: [0.025, 0.025, 0.025],  rot: [0, -24.20, 0] },
    { name: 'eye2',  pos: [0.05, 0.5, 0]/*[-0.168, 0.823, 0.930]*/, scale: [0.025, 0.025, 0.025],  rot: [0, -24.20, 0] }
];